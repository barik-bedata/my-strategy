...
এই ডকুমেন্টটি ডার্ক মোড (`#121212`) ব্যাকগ্রাউন্ডের ওপর ভিত্তি করে তৈরি একটি প্রিমিয়াম, হাই-রিটেনশন এবং ইন্টারন্যাশনাল স্ট্যান্ডার্ডের DSA (Data Structures & Algorithms) কোর্স প্রোডাকশন গাইডলাইন। লার্নিং সাইকোলজি (Learning Psychology) এবং মিনিমালিস্ট মোশন ডিজাইন ব্যবহার করে স্টুডেন্টদের Cognitive লোড কমানো এবং এনগেজমেন্ট বাড়ানোই এই গাইডের মূল উদ্দেশ্য।
...
| 🟡 **Yellow** | `#FFD700` | Active Focus / Current Step / Optimal | কারেন্ট পয়েন্টার (`slow`/`fast`), অ্যাক্টিভ নোড বা অপটিমাল Solution |
...
* **Top-Left Corner (Status Tracker):** পুরো ভিডিও জুড়ে স্টুডেন্ট কোন ফেজে আছে তা বোঝাতে এই ইন্ডিকেটরটি ফিক্সড থাকবে। ফেজ পরিবর্তনের সময় জাস্ট ১ সেকেন্ডের একটি স্মুথ **Cross-Fade** বা **Text Slide** অ্যানিমেশন হবে।
  ...
  * 🔴 `BRUTE FORCE` (ইন-এফিশিয়েন্ট বা প্রাথমিক Solution নির্দেশ করতে রেড)
  * 🟡 `OPTIMAL APPROACH` (অ্যাক্টিভ ফোকাস ও স্মার্ট Solutionb নির্দেশ করতে ইয়োলো)
...
* **রিসার্চ ও সায়েন্টিফিক ব্যাকগ্রাউন্ড (Sweller's Cognitive Load & Mayer's Redundancy Principle):** স্ক্রিনে একই সাথে একাধিক অ্যানিমেশন রাখা বা আগের সリューションের কোনো "অবশিষ্টাংশ বা কার্ড" স্থায়ীভাবে রেখে দিলে **Split-Attention Effect** তৈরি হয়। তাই এই কোর্সে **"Total Clean Slate"** মেথড ব্যবহার করা হবে।
  ...
  4. **Optimal পার্ট:** টপ-লেফটের ট্র্যাকার স্মুথলি চেঞ্জ হয়ে `🟡 OPTIMAL APPROACH` হবে। একদম ফ্রেশ, জঞ্জালহীন স্ক্রিনে অপটিমাল Solution অ্যানিমেশনটি বড় এবং আকর্ষণীয়ভাবে শুরু হবে। লজিক ব্যাখ্যা করার সময় আগের মতোই স্ক্রিনের নিচে কোনো আগাম কমপ্লেক্সিটি টেক্সট থাকবে না (**No Spoilers**)।
